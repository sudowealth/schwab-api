...
import { createSchwabAuthClient } from './unified-auth'
 ...
 * Now that BaseTokenHandler implements ITokenLifecycleManager, this class
 * can focus purely on delegating to the auth client.
 */
